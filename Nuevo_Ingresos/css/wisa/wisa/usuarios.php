    ...
    <div class="container-fluid">
     ...
     <div class="row animated fadeInUp">
        <div class="col-sm-12">
          ...
          <form class="form-horizontal form-material" action="usuarios.php" method="post" > 
        ...
        <form class="form-horizontal form-material" action="usuarios_add.php" method="post" >         
          ...
          <div class="col-md-6">
            <input type="text" class="form-control" placeholder="" value="<?php if (isset( $_POST["NoReloj"])) { echo $row['Nombre'] ;} ?>" name="nomb"> 
          </div>
          <div class="col-md-6">
        ...
        <div class="form-group">
                 <label class="col-md-2">Es instructor?:</label>
                   
          <select   class="col-md-2" name="tipo" >  
            <option value="2" <?php if (isset( $_POST["NoReloj"])) {  if  ($row['Tipo'] !='1') echo 'selected="selected"';} ?> > No</option>
            <option value="1" <?php if (isset( $_POST["NoReloj"])) {  if  ($row['Tipo'] =='1') echo 'selected="selected"';} ?> > Si</option> 
          </select>
