                    ...
                    <div class="white-box">
                        ...
                        <form class="form-horizontal form-material" action="solicitud_cc.php" method="POST">
                            ...
                            <div id="RadioTipoSoli">
                                <label class="col-md-12">Tipo de solcitud:</label>
                                ...
                                <div id="Modifica" class="desc">
                                    <div class="form-group ">
                                        ...
                                        <select class="col-md-4" id="carpM">
                                            <option value=""></option>
                                            <?php while($Carpetas=sqlsrv_fetch_array($proc_carpetas, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $Carpetas['Ruta']; ?>"><?php echo $Carpetas['NombreCarpeta']; ?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="col-md-2">
                                            <input class="btn btn-info" type="submit" name="btnCarpetas" id="btnCarpetas" value="Buscar carpetas">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <form class="form-horizontal form-material" action="solicitud_cc_add.php" method="POST" id="formReg">
                            ...
                            <input type="hidden" class="form-control" name="plnt" value="<?php if (isset($Planta)) { echo $Planta;} else {echo $row['Planta'];} ?>">
                            <input type="hidden" class="form-control" name="dept" value="<?php if (isset($Depto)) { echo $Depto;} else {echo ($row['Departamento']);} ?>">
