...
(function(e) {
	...
	(function() {
				...
				if("undefined"!=typeof t&&null!=t) {
					...
					return e(n).each(function() {
						...
						if(n.data(a)) {
							...
							, s=e.extend(!0, {}
							, l, o), c=Y.call(this, t), d=s.scrollInertia>0&&s.scrollInertia<17?17:s.scrollInertia;
			...
			r.bind("focusin."+i, function() {
				...
				o.is(n.advanced.autoScrollOnFocus)&&(Q(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer=a?(i+17)*a:0, t[0]._focusTimeout=setTimeout(function() {
					...
					"x"===n.axis||s[0]||G(t, e[0].toString(), {
						dir: "y", scrollEasing:"mcsEaseInOut", overwrite:c, dur:i
					}
		...
		, j=function(t, o, n, i, r) {
			...
			switch(o) {
				case"on": if(f.dir=[n===d[16]||n===d[15]||39===n||37===n?"x":"y", n===d[13]||n===d[15]||38===n||37===n?-1:1], Q(t), oe(n)&&"stepped"===f.type)return;
				l(m);
				break;
